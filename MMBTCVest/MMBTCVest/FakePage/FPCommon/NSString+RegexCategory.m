...
- (BOOL)isMobileNumber{
    ...
    //手机号 11位
    //1  34578
    NSString *mobileNoRegex = @"^[1][34578][0-9]{9}$";  // 下面正则 181 验证不了
    /**
...
//    ^([\u4e00-\u9fa5][a-zA-Z](([DF](?![a-zA-Z0-9]*[IO])[0-9]{4})|([0-9]{5}[DF])))|([冀豫云辽黑湘皖鲁苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼渝京津沪新京军空海北沈兰济南广成使领A-Z]{1}[a-zA-Z0-9]{5}[a-zA-Z0-9挂学警港澳]{1})$
    
    //车牌号:湘K-DE829 香港车牌号码:粤Z-J499港
//    NSString *carRegex = @"^[\u4e00-\u9fff]{1}[a-zA-Z]{1}[-][a-zA-Z_0-9]{4}[a-zA-Z_0-9_\u4e00-\u9fff]$";//其中\u4e00-\u9fa5表示unicode编码中汉字已编码部分，\u9fa5-\u9fff是保留部分，将来可能会添加
    NSString *carRegex = @"^([\u4e00-\u9fa5][a-zA-Z](([DF](?![a-zA-Z0-9]*[IO])[0-9]{4})|([0-9]{5}[DF])))|([冀豫云辽黑湘皖鲁苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼渝京津沪新京军空海北沈兰济南广成使领A-Z]{1}[a-zA-Z0-9]{5}[a-zA-Z0-9挂学警港澳]{1})$";
...
- (BOOL)isValidNum
{
    ...
    return [self isValidateByRegex:numRegex];
}
...
- (BOOL)isValidPostalcode {
    NSString *postalRegex = @"^[0-9]\\d{5}(?!\\d)$";
...
/// 密码正则匹配
- (BOOL)passwordCheck {
    NSString *carRegex = @"((?=.*\\d)(?=.*\\D)|(?=.*[a-zA-Z])(?=.*[^a-zA-Z]))^.{6,16}$";
    return [self isValidateByRegex:carRegex];
}
